 ...
 * desc:
 */
public class HeadAdapter extends BaseRecyclerViewAdapter<Test> {
    private static final String TAG = "HeadAdapter";

    public HeadAdapter(Context context, List<Test> data) {
        super(context, data, R.layout.adapter_test);
    }

    public HeadAdapter(Context context, List<Test> data, OnViewClickListener onViewClickListener) {
