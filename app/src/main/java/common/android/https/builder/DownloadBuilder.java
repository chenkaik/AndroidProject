...
import common.android.https.body.ResponseProgressBody;
import common.android.https.callback.DownloadCallback;
...
public class DownloadBuilder {
    ...
    public DownloadBuilder(NetWorkRequest request) {
