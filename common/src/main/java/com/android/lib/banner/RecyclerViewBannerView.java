...
public class RecyclerViewBannerView extends RecyclerViewBannerBaseView<LinearLayoutManager, BannerRecyclerAdapter> {
    ...
    public RecyclerViewBannerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RecyclerViewBannerView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    @Override
    protected BannerRecyclerAdapter getAdapter(Context context, List<Integer> list, OnBannerItemClickListener onBannerItemClickListener) {
        return new BannerRecyclerAdapter(context, list, onBannerItemClickListener);
    }
